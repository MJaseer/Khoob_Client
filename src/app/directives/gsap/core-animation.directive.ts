...
import {ElementRef, EventEmitter, Input, Output, ViewContainerRef} from '@angular/core';
...
export class CoreAnimationDirective {
  ...
  constructor(protected element: ElementRef) {
    this.element.nativeElement.addEventListener('animate-out', ({detail}:{detail:any}) => {
